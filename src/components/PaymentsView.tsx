              ...
              <div className="glass rounded-[var(--radius-lg)] overflow-hidden border border-[var(--border-default)]">
                <div className="p-4 border-b border-[var(--border-default)] flex items-center justify-between bg-[var(--bg-secondary)]">
                  ...
                  <button
                    ...
                    className="text-[10px] bg-[var(--bg-elevated)] hover:bg-white/[0.04] px-3 py-1.5 rounded-[var(--radius-md)] font-bold text-[var(--text-secondary)] transition-all border border-[var(--border-default)]"
                  >
                ...
                <div className="divide-y divide-[var(--border-default)]">
                  {filteredUnpaidMissions.map(mission => (
                    ...
                    >
                      <div className={`w-5 h-5 rounded-[var(--radius-sm)] border-2 flex items-center justify-center transition-all ${selectedMissionIds.includes(mission.id) ? 'bg-[var(--primary)] border-[var(--primary)]' : 'border-[var(--border-default)] bg-[var(--bg-elevated)]'}`}>
        ...
        <div className="space-y-4">
          ...
          {payments.length > 0 ? (
                    ...
                    <div key={payment.id} className="glass rounded-[var(--radius-lg)] overflow-hidden border border-[var(--border-default)] transition-all">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <h4 className="text-sm font-bold text-[var(--text-primary)] flex items-center gap-2">
                              {payment.client}
                              {payment.reference && <span className="text-[9px] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded text-[var(--text-tertiary)] font-mono">#{payment.reference}</span>}
                            </h4>
                        ...
                        <div className="flex items-center justify-between md:justify-end gap-6 text-right">
                          ...
                          <div className="flex items-center gap-3">
                            <button
                              ...
                              className="p-2 rounded-[var(--radius-md)] text-[var(--text-tertiary)] hover:text-[var(--danger)] hover:bg-[var(--danger-light)] transition-all duration-[var(--dur-fast)] active:scale-95"
                      ...
                      {isExpanded && (
                        <div className="px-4 pb-4 border-t border-[var(--border-default)] bg-[var(--bg-secondary)] animate-slide-down">
                          <div className="pt-4 divide-y divide-[var(--border-subtle)]">
            ...
            <div className="glass rounded-[var(--radius-lg)] p-12 text-center border border-[var(--border-default)] bg-[var(--bg-secondary)]">
              ...
              <p className="text-sm font-bold text-[var(--text-secondary)]">Aucun virement enregistré</p>
              <p className="text-xs text-[var(--text-tertiary)] mt-1">Vos virements bancaires groupés apparaîtront ici</p>
              <button
                type="button"
                onClick={() => setActiveTab('reconcile')}
                className="mt-4 rounded-[var(--radius-md)] border border-[var(--primary)] bg-[var(--primary-light)] px-3 py-2 text-xs font-bold text-[var(--primary)] transition-all duration-[var(--dur-fast)] active:scale-95"
              >
