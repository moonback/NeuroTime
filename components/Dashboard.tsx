...
import { Clock, CheckCircle, TrendingUp, Calendar, MapPin, Briefcase, Euro, Download, Moon, Sun, Upload, Database, Save, TrendingDown, Award, DollarSign, ChevronDown, ChevronUp, RefreshCcw, FileText, File, Edit, ArrowRight } from 'lucide-react';
import { format, startOfMonth, endOfMonth, subMonths, parseISO, differenceInHours, differenceInDays, differenceInMinutes, isToday, isTomorrow } from 'date-fns';
